...
<div class="row g-3 mb-2">
  <div class="col-md-3">
    ...
    <input type="text" id="facturaNumeroInput" class="form-control" placeholder="Ej: 0001-00001234">
  </div>
  <div class="col-md-3">
  ...
  <div class="col-md-3">
    ...
    <input type="text" id="ticketVendedor" class="form-control" placeholder="Nombre del vendedor">
  </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0 bg-transparent shadow-none">
        <div class="modal-body text-center p-0">
          <img id="imgTemporal" src="components/ventas/assets/losgenios.png" alt="Comprobante" class="img-fluid rounded" style="max-width:400px">
        </div>
      </div>
    </div>
  </div>
